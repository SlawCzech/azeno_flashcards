...
def calculate_new_ratings(player_a_rating, player_b_rating, modifier, outcome):
    ...
    # new rating if B wins
        ...
        player_a_rating = player_a_rating + k * (0 - probability_of_player_a_winning)
        player_b_rating = player_b_rating + k * (1 - probability_of_player_b_winning)

    print(f'New rating of player A: {round(player_a_rating, 2)}, new rating of player B: {round(player_b_rating, 2)}')


calculate_new_ratings(player_a_rating, player_b_rating, k, d)
